#ifndef INFINI_CCL_DEVICES_ALI_CASTER_CUH_
#define INFINI_CCL_DEVICES_ALI_CASTER_CUH_
...
template <>
struct HardwareCastImpl<Device::Type::kAli, float, half> {
  __host__ __device__ static float Apply(half x) { return __half2float(x); }
};

template <>
struct HardwareCastImpl<Device::Type::kAli, half, float> {
  __host__ __device__ static half Apply(float x) { return __float2half(x); }
};

template <>
struct HardwareCastImpl<Device::Type::kAli, float, __nv_bfloat16> {
...
template <>
struct HardwareCastImpl<Device::Type::kAli, __nv_bfloat16, float> {
...
template <>
struct HardwareCastImpl<Device::Type::kAli, __nv_bfloat16, int> {
...
template <>
struct HardwareCastImpl<Device::Type::kAli, half, int> {
  __host__ __device__ static half Apply(int x) { return __int2half_rn(x); }
};

template <>
struct HardwareCastImpl<Device::Type::kAli, __nv_bfloat16, double> {
...
template <>
struct HardwareCastImpl<Device::Type::kAli, half, double> {
  __host__ __device__ static half Apply(double x) { return __double2half(x); }
};

template <>
struct HardwareCastImpl<Device::Type::kAli, half, __nv_bfloat16> {
  __host__ __device__ static half Apply(__nv_bfloat16 x) { return __half(x); }
};

}  // namespace infini::ccl

#endif  // INFINI_CCL_DEVICES_ALI_CASTER_CUH_
